    ...
    <table class="form-table" role="presentation">
            ...
            <td>
                <fieldset>
                    <label>
                        ...
                        <?php esc_html_e( 'Local — Serve from Territory Manager CPTs on this site', 'owbn-entities' ); ?>
                    </label><br>
                    <label>
                        <input type="radio"
                            name="<?php echo esc_attr( owc_option_name( 'territories_mode' ) ); ?>"
        ...
        <tr class="owc-territories-remote" <?php echo $mode === 'remote' ? '' : 'style="display:none;"'; ?>>
            ...
            <td>
                ...
                <p class="description"><?php esc_html_e( 'Only set if territories come from a different gateway than the default.', 'owbn-entities' ); ?></p>
            </td>
        </tr>
        <tr class="owc-territories-remote" <?php echo $mode === 'remote' ? '' : 'style="display:none;"'; ?>>
...
<table class="widefat owc-tab-status">
    <tbody>
        ...
        <?php if ( $mode === 'local' ) : ?>
        <tr>
            <th><?php esc_html_e( 'Territory Manager', 'owbn-entities' ); ?></th>
            <td><?php echo $tm_active ? esc_html__( 'Active', 'owbn-entities' ) : esc_html__( 'Not installed', 'owbn-entities' ); ?></td>
        </tr>
        <tr>
            <th><?php esc_html_e( 'Published Territories', 'owbn-entities' ); ?></th>
        ...
        <tr>
            ...
            <td><?php echo is_array( $territories_cache ) ? absint( count( $territories_cache ) ) : esc_html__( 'None', 'owbn-entities' ); ?></td>
        </tr>
    </tbody>
</table>
...
<div class="owc-data-search" data-action="owc_search_territories">
    ...
    <input type="text" class="owc-data-search-input"
        placeholder="<?php esc_attr_e( 'Search territories...', 'owbn-entities' ); ?>"
