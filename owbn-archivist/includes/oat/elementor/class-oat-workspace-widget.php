...
class OWC_OAT_Workspace_Widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'Archivist Workspace', 'owbn-archivist' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section( 'content_section', array(
			'label' => __( 'Section', 'owbn-archivist' ),
			'tab'   => Controls_Manager::TAB_CONTENT,
		) );

		$this->add_control( 'section', array(
			'label'   => __( 'Show Section', 'owbn-archivist' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'self',
			'options' => array(
				'sites'       => __( 'OWBN Sites (SSO buttons)', 'owbn-archivist' ),
				'self'        => __( 'My Stuff', 'owbn-archivist' ),
				'chronicles'  => __( 'My Chronicles', 'owbn-archivist' ),
				'coordinators' => __( 'My Coordinator Roles', 'owbn-archivist' ),
				'exec'        => __( 'Executive Roles', 'owbn-archivist' ),
			),
		) );

		$this->add_control( 'section_title', array(
			'label'       => __( 'Section Title', 'owbn-archivist' ),
			'type'        => Controls_Manager::TEXT,
			'default'     => '',
			'placeholder' => __( 'Auto (based on section)', 'owbn-archivist' ),
			'description' => __( 'Leave blank to use the default title for the section.', 'owbn-archivist' ),
		) );

		$this->add_control( 'show_inbox_count', array(
			'label'     => __( 'Show Inbox Count', 'owbn-archivist' ),
		...
		$this->start_controls_section( 'custom_cards_section', array(
			'label' => __( 'Custom Cards', 'owbn-archivist' ),
			'tab'   => Controls_Manager::TAB_CONTENT,
		) );
		...
		$repeater->add_control( 'card_title', array(
			'label'       => __( 'Card Name', 'owbn-archivist' ),
			'type'        => Controls_Manager::TEXT,
			'default'     => 'Resources',
			'description' => __( 'Links with the same card name are grouped together.', 'owbn-archivist' ),
		) );

		$repeater->add_control( 'link_label', array(
			'label' => __( 'Link Label', 'owbn-archivist' ),
			'type'  => Controls_Manager::TEXT,
		) );

		$repeater->add_control( 'link_url', array(
			'label'         => __( 'Link URL', 'owbn-archivist' ),
		...
		$repeater->add_control( 'link_sso', array(
			'label'   => __( 'Route through SSO', 'owbn-archivist' ),
			'type'    => Controls_Manager::SWITCHER,
			'default' => 'yes',
		) );

		$repeater->add_control( 'card_visibility', array(
			'label'   => __( 'Show to', 'owbn-archivist' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'everyone',
			'options' => array(
				'everyone'    => __( 'Everyone (logged in)', 'owbn-archivist' ),
				'chronicle'   => __( 'Chronicle staff only', 'owbn-archivist' ),
				'coordinator' => __( 'Coordinators only', 'owbn-archivist' ),
				'exec'        => __( 'Exec only', 'owbn-archivist' ),
			),
		) );
		...
		$this->start_controls_section( 'style_section', array(
			'label' => __( 'Style', 'owbn-archivist' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		) );

		$this->add_control( 'section_heading_color', array(
			'label'     => __( 'Heading Color', 'owbn-archivist' ),
	...
	protected function render() {
		if ( ! is_user_logged_in() ) {
			echo '<p>' . esc_html__( 'Please log in.', 'owbn-archivist' ) . '</p>';
			return;
		}
