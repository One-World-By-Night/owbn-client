...
add_action('admin_menu', function () {
    ...
    add_options_page(
        CCC_LABEL . ' ' . __('Client Settings', 'owbn-cc-client'),
        CCC_LABEL . ' ' . __('Client', 'owbn-cc-client'),
        'manage_options',
        $client_id . '-ccc-settings',
...
?>
    <div class="wrap">
        <h1><?php echo esc_html(CCC_LABEL . ' ' . __('Client Settings', 'owbn-cc-client')); ?></h1>
