...
= 4.20.9 =
* Fix: OAT dashboard links point to archivist on remote sites

= 4.20.8 =
* Fix: Dedup gateway inbox by entry_id, add titles to inbox API response

= 4.20.7 =
* Fix: Dashboard widget links open in new tabs, add Full Registry + New Submission links

= 4.20.6 =
* Fix: Remove one-shot flag so new OAT pages auto-create on existing sites

= 4.20.5 =
* Fix: Add oat-registry-detail page to auto-creation, create missing OAT pages on all sites

= 4.20.4 =
* Fix: Exec roles show as coordinator entries with View/Edit links
* Fix: OAT widget links point to archivist on remote sites

= 4.20.3 =
* Feature: OAT My Characters dashboard widget
* Feature: OAT Inbox dashboard widget
* Fix: C&C widget now shows exec roles

= 4.20.2 =
* Feature: "My Chronicles & Coordinators" dashboard widget with View/Edit links

= 4.20.1 =
* Feature: ASC roles listing on user profile page with per-user Refresh button

= 4.20.0 =
* Feature: Clear ASC role cache on login for always-fresh roles
* Feature: "Refresh my Roles" button in admin bar Howdy menu
* Fix: Add no-cache headers to gateway API responses

= 4.19.6 =
* Fix: Replace NPC Coordinator/Type fields with entity picker, toggle PC/NPC sections cleanly
